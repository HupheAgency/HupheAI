...
export const RIGHT_PANEL_STYLE = {
  ...
  contentColumn: 'flex h-full flex-col transition-opacity duration-200',
  contentOpen: 'opacity-100',
  contentClosed: 'pointer-events-none opacity-0',
  tabBarRoot: 'flex-shrink-0 bg-[#131313]',
  tabBarInner: 'flex items-end border-b border-white/[0.08]',
  tabBarIndent: 'pl-11',
  tabButton: 'relative px-4 py-3 text-[13px] font-semibold leading-none transition-colors',
  tabButtonActive: 'mb-[-1px] rounded-tl-[10px] rounded-tr-[10px] border border-b-[#1e1e1e] border-white/[0.10] bg-[#1e1e1e] text-white/90',
  tabButtonInactive: 'text-white/35 hover:text-white/60',
