...
function copyPythonScripts(): import('vite').Plugin {
  const scripts = ['parse_key.py', 'write_key.py', 'parse_key_slides.py', 'lib/colmap_sfm.py', 'lib/generate_marker_frame.py', 'lib/vggt_to_colmap.py', 'lib/ply_to_colmap_points.py', 'lib/clay_convert.py']
  return {
